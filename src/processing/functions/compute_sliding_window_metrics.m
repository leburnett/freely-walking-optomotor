...
%   Also passes through distance from arena centre (dist_data).
%
%   INPUTS:
...
%       .centre_dist - distance from arena centre (mm), same as dist_data
%
%   EXAMPLE:
...
%% Distance from arena centre (pass through dist_data)
metrics.centre_dist = dist_data;
