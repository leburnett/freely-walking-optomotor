...
all_conditions = [
    21, 64, 15, 1; % 0.8 shift
    21, 127, 15, 2; % 0.8 shift
    22, 64, 15, 3; % 0 shift
    22, 127, 15, 4; % 0 shift
    23, 64, 15, 5; % -0.8 shift
    23, 127, 15, 6; % -0.8 shift
];  
...
% Run through all 6 conditions twice
for j = [1,2] 
    ...
    %start LOOP
     for i = 1:num_conditions
        ...
        Log = present_shifted_stimulus(current_condition, all_conditions, vidobj);
