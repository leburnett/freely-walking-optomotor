...
%% 3 - Average path straightness during the first 3s of the stimulus 

    [p, mean_per_strain, mean_per_strain_control] = welch_ttest_for_rng_straightness(x_data, x_data_control, y_data, y_data_control, rng_start_3);
