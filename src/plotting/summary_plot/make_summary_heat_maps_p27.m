...
%               same number of ES flies as the target line.  
    ...
    [~, ~, adj_p_all]=fdr_bh(pvals_all_cond, 0.05, 'dep', 'yes');
    ...
    f = gcf;
    f.Position = [186   315   214   612]; %[118   469   156   466]; %[118   469   363   466]; %[118   469   467   466]; % [2612  -522  373  1588]; %[564    73   362   974];
