function fig = plot_metric_vs_viewing_distance(bin_centres, stim_means, stim_sems, pre_means, pre_sems, metric_name, opts)
% PLOT_METRIC_VS_VIEWING_DISTANCE  Single-panel metric vs viewing distance.
%
%   fig = PLOT_METRIC_VS_VIEWING_DISTANCE(bin_centres, stim_means, stim_sems,
%       pre_means, pre_sems, metric_name, opts)
%
%   Plots stimulus and baseline as mean lines with SEM shading and small
%   markers at each bin centre, with viewing distance on the x-axis.
%   Viewing distance is the ray-cast distance from the fly to the arena
%   wall along its current heading direction.
%
%   INPUTS:
%     bin_centres  - [1 x n_bins] viewing distance bin centres (mm)
...
%     fig - figure handle
%
% See also: plot_metric_vs_centre_distance, calculate_viewing_distance
...
% --- Reference line at arena radius (120 mm) ---
xline(120, '-', 'Color', [0.7 0.7 0.7], 'LineWidth', 0.5, 'HandleVisibility', 'off');
