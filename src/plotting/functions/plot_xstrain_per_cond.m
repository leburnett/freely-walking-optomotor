function plot_xstrain_per_cond(protocol, data_type, cond_ids, strain_ids, params, DATA)
...
if params.plot_sd == 1
    ...
    elseif data_type == "av_data"
        if delta, rng = [-200 200]; else, rng = [-200 200]; end
...
for strain_id = strain_ids

    strain = strain_names{strain_id};
    col = strain_colours(strain_id, :);
