% Protocol_34.m  - short protocol with low luminance 60 degree grating and
% flicker. 
% GS_VAL = 3, on value = 1, off value = 0.
...
% Protocol parameters: 
t_acclim_start = 30; %00; %300; % 5 minutes of recording behaviour in the dark before the experiment begins.
...
all_conditions = [ 
    69, 47, 64, 1, 15, t_interval, 1; %  60 deg gratings - 4Hz - low luminance
    68, 47, 8, 1, 15, t_interval, 2;  % Flicker - 4Hz
];  
