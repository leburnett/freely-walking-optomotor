function DATA = comb_data_across_cohorts_cond_v2(protocol_dir, pattern_dir, verbose)
% COMB_DATA_ACROSS_COHORTS_COND_V2 Enhanced data combiner with pattern metadata
%
...
%
% This is an enhanced version of comb_data_across_cohorts_cond.m that maintains
...
%   .phase_markers      - NEW: Frame boundaries for baseline/dir1/dir2/interval
%   .pattern_meta       - NEW: Linked pattern metadata from _pattern_lut
...
%
% See also: comb_data_across_cohorts_cond, parse_pattern_metadata,
%           build_pattern_lookup, discover_strains, get_protocol_config
    ...
    if ~isfolder(protocol_dir)
        error('comb_data_across_cohorts_cond_v2:DirectoryNotFound', ...
    ...
    if n_files == 0
        error('comb_data_across_cohorts_cond_v2:NoDataFiles', ...
