function get_total_fly_numbers()
    
    results_folder = '/Users/burnettl/Documents/Projects/oaky_cokey/results/protocol_27';
    % cd(results_folder)
    DATA = comb_data_across_cohorts_cond(results_folder);
