...
# Load project-wide config (repo root is 4 levels up: monitor_and_track -> automation -> python -> repo)
...
def run_matlab_tracking(folder_path):
    ...
    try:
        ...
        cmd = f'matlab -batch "run(\'{setup_path}\'); cd(\'{folder_path_matlab}\'); {MATLAB_FUNCTION}(\'{folder_path_matlab}\')"'
