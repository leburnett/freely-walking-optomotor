...
function process_freely_walking_optomotor(path_to_folder, save_figs, genotype)
    ...
    figure_save_folder = '/Users/hms/Documents/Fly Tracking';
    data_save_folder = '/Users/hms/Documents/Fly Tracking';
    ...
    for exp  = 1:n_time_exps
        ...
        datapoints = make_mean_vel_datapoints(Log, feat, n_flies, n_conditions, fps);
