function selections = get_video_observations()
    ...
    fig = uifigure('Name', 'Video Observations', 'Position', [1278 402 330 350]);
    ...
    turningDropdown = uidropdown(fig, ...
        ...
        'Items', {'None', 'LargeLoops', 'SmallLoops', 'TightLoops', 'LoopSnap', 'Pirouette', 'Pivot', }, ...
        'Value', 'None');
    ...
    distDropdown = uidropdown(fig, ...
        ...
        'Items', {'Diffuse', 'Clustered', 'Mixed', 'Edge', 'NA'}, ...
        'Value', 'NA');
    ...
    uilabel(fig, 'Position', [20 50 110 22], 'Text', 'Resp homog.(%):');
