...
function f = line_per_cond_one_grp(DATA, gp_data, data_type, grp2plot, cond2plot, fast_slow)
...
for idx2 = cond2plot
    ...
    if isfield(data, rep1_str)
        ...
        y_grp = vertcat(y_grp, mean(y_data));
    ...
    plot(x_grp, y_grp, '-', 'Color', col, 'LineWidth', 1.2)
    hold on
    scatter(x_grp, y_grp, 50, 'o', 'MarkerFaceColor', col, 'MarkerEdgeColor', col)
