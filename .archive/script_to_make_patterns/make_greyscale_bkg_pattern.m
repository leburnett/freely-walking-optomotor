...
bkg_val = 1; % With 'gs_val' = 4 the range is between 1 and 7. 

pattern.x_num = 2; % There are 2 frames in the pattern.
...
% Pats(:, :, 2) = Pats(:, :, 1);
Pats(:, :, 2) = repmat(ones(1,16)*bkg_val, 3, 12);
...
str = [directory_name '\Pattern_48_full_flashes_0_1_binary_2frames.mat']; 	% name must begin with ‘Pattern_’
save(str, 'pattern');
