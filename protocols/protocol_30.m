...
all_conditions = [ 
    1, 47, 64, 1, 15, t_interval, 1; %
    1, 47, 64, 1, 15, t_interval, 2; % 
    1, 47, 64, 1, 15, t_interval, 3; %
    1, 47, 64, 1, 15, t_interval, 4; %
    1, 47, 64, 1, 15, t_interval, 5; % 
    1, 47, 64, 1, 15, t_interval, 6; % 
    1, 47, 64, 1, 15, t_interval, 7; %
];  
...
for j = [1,2] 
    ...
    %start LOOP
     for i = 1:num_conditions
         ...
         if j ==1 % Increase in contrast
             current_condition = random_order(i);
         elseif j ==2 
             % Decrease in contrast. 
             random_order2 = flip(random_order);
             current_condition = random_order2(i);
         end 
        ...
        Log = present_optomotor_stimulus_diff_contrasts(current_condition, all_conditions, vidobj, d);
