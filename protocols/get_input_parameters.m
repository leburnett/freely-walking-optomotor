function [selectedStrain,selectedAge,selectedSex,selectedLightCycle] = get_input_parameters()
    ...
    strainDropdown = uidropdown(fig, ...
        ...
        'Items', {'csw1118', 'test', 'jfrc49_es_kir', 'ss324_t4t5_kir', 'jfrc_l1l4_kir', 'es_shibire', 'ss324_t4t5_shibire'}, ...
        'Value', 'csw1118');
