...
if on_off == 0 % dark bar on bright bkg:
    ...
    array1 = repmat([zeros(1, bar_pw), con_val*ones(1, int_pw)], 3, 2);
    array2 = repmat([(con_val*ones(1, int_pw/2)), zeros(1, bar_pw), con_val * ones(1, int_pw/2)], 3, 2);
elseif on_off == 1 % bright bar on dark bkg
    array1 = repmat([con_val*ones(1, bar_pw), zeros(1, int_pw)], 3, 2);
    array2 = repmat([zeros(1, int_pw/2), con_val*ones(1, bar_pw), zeros(1, int_pw/2)], 3, 2);
end 
