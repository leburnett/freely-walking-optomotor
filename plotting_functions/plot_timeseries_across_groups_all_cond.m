function plot_timeseries_across_groups_all_cond(DATA, gp_data, params, data_type, gps2plot, plot_sem)

% function f = plot_allcond_acrossgroups_timeseries(DATA, gp_data, params, data_type, gps2plot, plot_sem)
