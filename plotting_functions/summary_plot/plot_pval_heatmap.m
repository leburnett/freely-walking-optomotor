function plot_pval_heatmap(pvals_all, target_mean_all, control_mean_all, strain_names, condition_n)
    ...
    diff_array2(:,[6:end]) = diff_array2(:, [6:end])*-1; 
    ...
    hold on; 
    plot([1.5 1.5], [0 n_strains+1], 'k-', 'LineWidth', 1);
    plot([3.5 3.5], [0 n_strains+1], 'k-', 'LineWidth', 1.2);
    plot([5.5 5.5], [0 n_strains+1], 'k-', 'LineWidth', 1.2);
